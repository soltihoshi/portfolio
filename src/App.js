...
const projectText = [
    {
        ...
        goal : '계절이 바뀌는 시기가 도래하면 언제나 예년보다, 평년보다 춥고 덥다는 뉴스가 일상적으로 반복됩니다. 오늘 선택한 옷차림에 후회하지 않을 수 있도록 기온별로 옷차림을 추천해주는 화면을 제공하고 싶었습니다.',
        aim : '사용이 복잡하지 않고 보여주는 시각적 자료가 간결하여 해석하지 않아도 되는 정보 전달을 목표로 했습니다.',
        use : 'HTML CSS REACT TYPESCRIPT',
        feel : '처음에는 과거에 선택했던 옷차림새를 보여주거나, 월 단위의 날씨도 탐색할 수 있게 작업하였으나 화면이 너무 난잡하였습니다. 과연 사용자의 입장에서 보았을 때 이것이 유용하려면 어떤 정보를 담아야 할까? 같은 조언을 얻어서 해답을 찾는 고민의 시간이 있었습니다. 부가적인 기능은 최대한 배제하고 처음 목표했던 날씨와 옷차림의 관계에 집중하는 것을 목표로 삼았더니 불필요한 UI들을 제거할 수 있었습니다.',
        member : '1',
        url : '',
        git : '',
    },
